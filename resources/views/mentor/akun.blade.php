            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body dashboard-tabs  p-3">
                  ...
                  @endif
                  <form action="{{ route('simpan_mentee') }}" method="POST" >
                    @csrf
                    <div class="mb-3">
            ...
            <tr>
              <td>{{$i++}}</td>
                ...
                <i class="mdi mdi-table-edit"></i>
                            ...
                            <form action="{{ route('hapus_mentee', $acc->id_user) }}" method="POST" style="display: inline-block;">
                            @csrf  
                            @method('delete')
    ...
    <div class="modal fade" id="exampleModal{{$acc->id_user}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form action="{{ route('update_mentee', $acc->id_user) }}" method="post">
          @csrf  
          @method('PUT')
          <div class="mb-3">
