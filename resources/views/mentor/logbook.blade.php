            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body dashboard-tabs  p-3">
                  ...
                  @endif
                  <form action="{{ route('simpan_log') }}" method="POST" >
                    @csrf
            ...
            <tr>
              <td>{{$i++}}</td>
                ...
                <i class="mdi mdi-table-edit"></i>
                            ...
                            <form action="{{ route('hapus_log', $log->id_log) }}" method="POST" style="display: inline-block;">
                            @csrf  
                            @method('delete')
    ...
    <div class="modal fade" id="exampleModal{{$log->id_log}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form action="{{ route('update_log', $log->id_log) }}" method="post">
          @csrf  
          @method('PUT')
          <div class="mb-3">
